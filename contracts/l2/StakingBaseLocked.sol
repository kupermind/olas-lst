...
/// @title StakingBaseLocked - Base abstract smart contract for staking a service by its owner
abstract contract StakingBaseLocked is ERC721TokenReceiver {
    enum StakingState {
        Unstaked,
        Staked
    }
    ...
    function _initialize(
        ...
        if (_stakingParams.metadataHash == 0 || _stakingParams.maxNumServices == 0 ||
            ...
            _stakingParams.minNumStakingPeriods == 0) {
            revert ZeroValue();
        }
