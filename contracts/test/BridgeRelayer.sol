...
contract BridgeRelayer {
    ...
    address public arbitrumStakingProcessorL2;
    address public gnosisDepositProcessorL1;
    address public gnosisStakingProcessorL2;
    address public optimismDepositProcessorL1;
    address public optimismStakingProcessorL2;
    address public polygonDepositProcessorL1;
    address public polygonStakingProcessorL2;
    address public wormholeDepositProcessorL1;
    address public wormholeStakingProcessorL2;
    ...
    function setArbitrumAddresses(address _arbitrumDepositProcessorL1, address _arbitrumStakingProcessorL2) external {
        arbitrumDepositProcessorL1 = _arbitrumDepositProcessorL1;
        arbitrumStakingProcessorL2 = _arbitrumStakingProcessorL2;
    }

    function setGnosisAddresses(address _gnosisDepositProcessorL1, address _gnosisStakingProcessorL2) external {
        gnosisDepositProcessorL1 = _gnosisDepositProcessorL1;
        gnosisStakingProcessorL2 = _gnosisStakingProcessorL2;
    }

    function setOptimismAddresses(address _optimismDepositProcessorL1, address _optimismStakingProcessorL2) external {
        optimismDepositProcessorL1 = _optimismDepositProcessorL1;
        optimismStakingProcessorL2 = _optimismStakingProcessorL2;
    }

    function setPolygonAddresses(address _polygonDepositProcessorL1, address _polygonStakingProcessorL2) external {
        polygonDepositProcessorL1 = _polygonDepositProcessorL1;
        polygonStakingProcessorL2 = _polygonStakingProcessorL2;
    }

    function setWormholeAddresses(address _wormholeDepositProcessorL1, address _wormholeStakingProcessorL2) external {
        wormholeDepositProcessorL1 = _wormholeDepositProcessorL1;
        wormholeStakingProcessorL2 = _wormholeStakingProcessorL2;
    }
    ...
    function l2ToL1Sender() external view returns (address) {
        return arbitrumStakingProcessorL2;
    }
    ...
    function bridgeContracts(uint16) external view returns (bytes32) {
        return bytes32(uint256(uint160(wormholeStakingProcessorL2)));
    }

    function parseVM(bytes memory) external view returns (VM memory vm) {
        vm.emitterAddress = bytes32(uint256(uint160(wormholeStakingProcessorL2)));
    }
    ...
    function parseTransferWithPayload(bytes memory) external view returns (TransferWithPayload memory transfer) {
        ...
        transfer.to = bytes32(uint256(uint160(wormholeStakingProcessorL2)));
        transfer.toChain = 1;
