...
describe("Liquid Staking Optimized", function () {
    let serviceRegistry;
    ...
    const maxNumServices = 10; // Уменьшено с 100 для экономии памяти
    const minStakingDeposit = regDeposit;
    const fullStakeDeposit = regDeposit.mul(2);
    const timeForEmissions = oneDay * 7; // Уменьшено с 30 дней для экономии памяти
    let serviceParams = {
        maxNumServices,
